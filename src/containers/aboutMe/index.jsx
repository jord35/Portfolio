const AboutMe = () => {
    return (<section><p>Passionné par le développement web, j’ai choisi de me spécialiser dans la création d’interfaces modernes, accessibles et performantes.
        ...
        Mon objectif : développer des solutions web à la fois esthétiques, efficaces et maintenables, qui reflètent le professionnalisme et l’identité de chaque projet.</p></section>);
};
